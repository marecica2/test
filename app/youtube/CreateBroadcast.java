...
public class CreateBroadcast
{
    ...
    public static void init()
    {
        ...
        try
        {
            ...
            broadcastSnippet.setScheduledStartTime(new DateTime(System.currentTimeMillis() + (1000l * 60 * 60 * 24)));
            broadcastSnippet.setScheduledEndTime(new DateTime(System.currentTimeMillis() + (1000l * 60 * 60 * 26)));
