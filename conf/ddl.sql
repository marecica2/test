...
delete from attendance where event_id in (select id from event where customer_id = 334);
delete from attendance where event_id in (select id from event where user_id = 334);
