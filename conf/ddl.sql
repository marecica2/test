...
delete from activity where user_id = 372;
delete from activity where customer_id = 372;
delete from activity where event_id in (select id from event where user_id = 372);
delete from activity where event_id in (select id from event where customer_id = 372);
delete from message where fromuser_id = 372;
delete from message where owner_id = 372;
delete from message where touser_id = 372;
delete from comment_comment_reply where comment_id in (select id from comment where user_id = 372);
delete from comment_comment_reply where replies_id in (select id from comment_reply where user_id = 372);
delete from comment where user_id = 372;
delete from comment_reply where user_id = 372;
delete from attendance where user_id = 372;
delete from attendance where customer_id = 372;
delete from attendance where event_id in (select id from event where customer_id = 372);
delete from attendance where event_id in (select id from event where user_id = 372);
delete from event where user_id = 372;
delete from event where customer_id = 372;
delete from fileupload where owner_id  = 372;
delete from listing where user_id = 372;
delete from contact where user_id = 372;
delete from contact where contact_id = 372;
delete from ratingvote where user_id = 372;
delete from rating where user_id = 372;
delete from users where id = 372;